...
void APPS_Main_Parser(Can_Message msg1)
{
	...
	apps1.Pedal_Position = msg1.return_Data(0) << 8 | msg1.return_Data(1);
	apps1.diff = msg1.return_Data(2);
	apps1.state = msg1.return_Data(4);
}

void BMS_LV_Main_Parser(Can_Message msg1)
{
	handler1.Update_DataBuffer1_flag(0x02);
	bmslv1.Voltage_Sum = msg1.return_Data(0) << 8 | msg1.return_Data(1);
	bmslv1.Soc = msg1.return_Data(2);
	bmslv1.Temps = msg1.return_Data(3);
	bmslv1.Current = msg1.return_Data(4);
	bmslv1.state = msg1.return_Data(5);
}
