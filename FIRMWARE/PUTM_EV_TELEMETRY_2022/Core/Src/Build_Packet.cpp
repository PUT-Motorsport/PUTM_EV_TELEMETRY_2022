...
void APPS_Parser  (Packet_1 *pck1, Can_Message *msg1);
void BMS_LV_Parser(Packet_1 *pck1, Can_Message *msg1);
...
{
	 void (*APPS_ptr)  (Packet_1*, Can_Message*) = APPS_Parser;
	 void (*BMS_LV_ptr)(Packet_1*, Can_Message*) = BMS_LV_Parser;
	 	 	 	 	 	 	 	 /*
	 	 	 	 	 	 	 	  *
	 	 	 	 	 	 	 	  *
	 	 	 	 	 	 	 	  *
...
*/
bool Packet_1::Choose_Parser(Can_Message *msg1)
{
