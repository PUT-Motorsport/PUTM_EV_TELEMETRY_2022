...
class Can_interface {
  ...
  Device<BMS_HV_main> bms_hv_main{BMS_HV_MAIN_CAN_ID,3};
  Device<BMS_LV_main> bms_lv_main{BMS_LV_MAIN_CAN_ID,4};
  Device<BMS_LV_temperature> bms_lv_temperature{BMS_LV_TEMPERATURE_CAN_ID,5};
  Device<Dash_Main> dash_main{DASH_MAIN_CAN_ID,6};
  Device<Dash_TCS> dash_TCS{DASH_TCS_CAN_ID,7};
  Device<Dash_Smart_Fuses_FAN_speed> dash_fan_speed{DASH_SMART_FUSES_FAN_SPEED_CAN_ID,8};
  Device<Dash_steering_wheel_request> dash_steering_request{DASH_STEERING_WHEEL_REQUEST_CAN_ID,9};
  Device<Dash_lap_finished> dash_lap_finished{DASH_LAP_FINISHED_CAN_ID,10};
  Device<Lap_timer_Main> laptimer_main{LAP_TIMER_MAIN_CAN_ID,11};
  Device<Lap_timer_Pass> laptimer_pass{LAP_TIMER_PASS_CAN_ID,12};
  Device<SF_main> sf_main{SF_MAIN_CAN_ID,12};
  Device<SF_FrontBox> sf_frontbox{SF_FRONTBOX_CAN_ID,14};
  Device<SF_CoolingAndVSafety> sf_coolingandvsafety{SF_COOLINGANDVSAFETY_CAN_ID,15};
  Device<SF_DV> sf_dv{SF_DV_CAN_ID,16};
  Device<SF_WS> sf_ws{SF_WS_CAN_ID,17};
  Device<SF_NUCS> sf_nucs{SF_NUCS_CAN_ID,18};
  Device<Steering_Wheel_main> steering_wheel_main{STEERING_WHEEL_MAIN_CAN_ID,19};
  Device<Steering_Wheel_event> steering_wheel_event{STEERING_WHEEL_EVENT_CAN_ID,20};
  Device<TS_main> ts_main{TS_MAIN_CAN_ID,21};
  Device<TS_rear_suspension> ts_rear_suspension{TS_REAR_SUSPENSION_CAN_ID,22};
  Device<Telemetry_Main> telemetry_main{TELEMETRY_MAIN_CAN_ID,23};
public:
  ...
  Dash_Smart_Fuses_FAN_speed get_dash_fan_speed() {return dash_fan_speed.data;}
  Dash_steering_wheel_request get_dash_steering_wheel_request() {return dash_steering_request.data;}
  ...
  bool get_dash_steering_wheel_request_new_data() {return dash_steering_request.get_new_data();}
  bool get_dash_lap_finished_new_data() {return dash_lap_finished.get_new_data();}
